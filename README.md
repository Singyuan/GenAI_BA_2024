...
|<a href="#Variational-Autoencoder-VAE">5</a>|5/7|VAE|<ul><li>Introduction to VAE</li><li>Reconstruct digit images</li><li>Generate new digits by sampling from the learned latent space</li><li>Visualize the structure of the 2D latent manifold.</li></ul>|<ul><li>[VAE](https://colab.research.google.com/drive/1VFwG_Q3UYbX9t-kkETXl4R97el_wJilO?usp=sharing)</li></ul>||
